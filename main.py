...
if __name__ == '__main__':
    ...
    image_logo = image_logo.resize((int(756 / 5), int(144 / 5)), Image.LANCZOS)
    image_logo_re: PhotoImage = ImageTk.PhotoImage(image_logo)
    ...
    image_black = image_black.resize((640, 480), Image.LANCZOS)
